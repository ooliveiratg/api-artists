...
const config = {
  "generator": {
    ...
    "output": {
      "value": "C:\\Users\\oliveira\\Documents\\api-artistas\\src\\models\\src\\generated\\prisma",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
  ...
  "inlineSchemaHash": "8bae44d2fe6e313adc4c4f78a8981e6e9e36e17b27ab23bbe37dc4720734105e",
  "copyEngine": true
}
...
if (!fs.existsSync(path.join(__dirname, 'schema.prisma'))) {
  const alternativePaths = [
    "src/models/src/generated/prisma",
    "models/src/generated/prisma",
  ]
...
path.join(process.cwd(), "src/models/src/generated/prisma/query_engine-windows.dll.node")
// file annotations for bundling tools to include these files
path.join(__dirname, "schema.prisma");
path.join(process.cwd(), "src/models/src/generated/prisma/schema.prisma")
